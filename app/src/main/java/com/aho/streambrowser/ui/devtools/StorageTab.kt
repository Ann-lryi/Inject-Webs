...
class StorageTab(private val host: DevToolsHost) : DevToolsTab {
    ...
    override fun buildView(): View {
        ...
        inner.addView(TextView(ctx).apply {
            text = "localStorage + sessionStorage"; textSize = 12f
        ...
        host.webView.evaluateJavascript(
            "(function(){try{var ls={},ss={};for(var i=0;i<localStorage.length;i++)" +
    ...
    private fun btn(label: String, color: Int) = TextView(host.hostContext).apply {
